...
class ChangeMessage2ViewController: UIViewController {
    ...
    @IBAction func sendPressed(_ sender: UIButton) {
        ...
        let device4Body =
            ...
            "\(password)242\(vung3.text!)\(vung4.text!)" +
            "\(password)243\(vung5.text!)\(vung6.text!)" +
            "\(password)244\(vung7.text!)\(vung8.text!)" +
            "\(password)245\(vung9.text!)\(vung10.text!)" +
            "\(password)246\(vung11.text!)\(vung12.text!)" +
            "\(password)247\(vung13.text!)\(vung14.text!)" +
            "\(password)248\(vung15.text!)\(vung16.text!)"
